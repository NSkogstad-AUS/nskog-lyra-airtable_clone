...
export default function PasswordPage() {
  ...
  const canSubmit = password.length > 0 && !isLoading;
    ...
    <main className={styles.page}>
      <div className={styles.content}>
        <section className={styles.left}>
          ...
          <h1 className={styles.title}>Enter your password to sign in</h1>
        ...
        <aside className={styles.right} aria-hidden>
          <a
            ...
            aria-label="Learn about Airtable's AI app building platform"
          >
            <Image
